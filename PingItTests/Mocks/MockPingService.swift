...
final class MockPingService: PingServicing {
    ...
    var rsvpPingCalled = false
    var hasUserRSVPdResult = false
    var rsvpPingResult = RSVPPingResult(rsvpCount: 1, isAttending: true)
    var lastRSVPdPingId: String?
